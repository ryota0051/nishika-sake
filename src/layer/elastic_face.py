...
class ElasticArcFace(nn.Module):
    def __init__(self, in_features, out_features, s=30, m=0.50,std=0.0125,plus=False):
...
class ElasticCosFace(nn.Module):
    def __init__(self, in_features, out_features, s=30, m=0.35,std=0.0125, plus=False):
