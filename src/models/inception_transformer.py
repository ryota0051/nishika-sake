...
default_cfgs = {
    "iformer_small": _cfg(
        url="https://huggingface.co/sail/dl2/resolve/main/iformer/iformer_small.pth"
    ),
    "iformer_base": _cfg(
        url="https://huggingface.co/sail/dl2/resolve/main/iformer/iformer_base.pth"
    ),
    "iformer_large": _cfg(
        url="https://huggingface.co/sail/dl2/resolve/main/iformer/iformer_large.pth"
    ),
    "iformer_small_384": _cfg(
        url="https://huggingface.co/sail/dl2/resolve/main/iformer/iformer_small_384.pth",
        input_size=(3, 384, 384),
        crop_pct=1.0,
    ),
    "iformer_base_384": _cfg(
        url="https://huggingface.co/sail/dl2/resolve/main/iformer/iformer_base_384.pth",
        input_size=(3, 384, 384),
        crop_pct=1.0,
    ),
    "iformer_large_384": _cfg(
        url="https://huggingface.co/sail/dl2/resolve/main/iformer/iformer_large_384.pth",
        input_size=(3, 384, 384),
        crop_pct=1.0,
    ),
}
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.pos_embed1 = nn.Parameter(
            torch.zeros(1, num_patches, num_patches, embed_dims[0])
        )
        ...
        self.pos_embed2 = nn.Parameter(
            torch.zeros(1, num_patches, num_patches, embed_dims[1])
        )
        ...
        self.pos_embed3 = nn.Parameter(
            torch.zeros(1, num_patches, num_patches, embed_dims[2])
        )
        ...
        self.pos_embed4 = nn.Parameter(
            torch.zeros(1, num_patches, num_patches, embed_dims[3])
        )
    ...
    def _get_pos_embed(self, pos_embed, num_patches_def, H, W):
        if H * W == num_patches_def * num_patches_def:
            ...
            return F.interpolate(
                pos_embed.permute(0, 3, 1, 2), size=(H, W), mode="bilinear"
            ).permute(0, 2, 3, 1)
